...
export default function Home() {
  const isScriptDeployed = offckb.myScripts['sudt'] != null;
  return (
    <ccc.Provider>
      <div className="max-w-screen-md mx-auto mt-10">
        ...
        <div className="my-6">
          ...
          <div>
            ...
            {isScriptDeployed ? (
              <div>
                <li>code_hash: {offckb.myScripts['sudt']?.codeHash}</li>
                <li>hash_type: {offckb.myScripts['sudt']?.hashType}</li>
                <li>
                  outpoint: {offckb.myScripts['sudt']?.cellDeps[0].cellDep.outPoint.txHash}:
                  {offckb.myScripts['sudt']?.cellDeps[0].cellDep.outPoint.index}
                </li>
              </div>
            ) : (
              <span>
